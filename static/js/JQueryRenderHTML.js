...
addDom = (country) => {
    ...
    var countryAndbar = '<div class="row"><div id="second-chart" class="col-6"><div id="country" style="align-items: center;"></div></div><div id="third-chart" class="col-md-6 p-0"><div id="bar"></div></div></div>'
    ...
    $("#country").append('<img class="mini-map map-background" src="http://2.bp.blogspot.com/-8P_iI3YueO0/T73feHn5VSI/AAAAAAAAAiw/N5N3HmVmk9I/s1600/6a00d834516a0869e2016760f339c3970b-800wi.jpg" alt="Big Smileys" />')
